...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemscope itemType="http://schema.org/WebPage">
	...
	<div class="entry-content" itemprop="mainContentOfPage">
		...
		<?php if ( function_exists( 'get_the_post_navigation' ) ) {
				...
				echo get_the_post_navigation( array(
					'prev_text'	=> __('&larr; Previous Page', 'bp'),
					'next_text'	=> __( 'Next Page &rarr;', 'bp'),
					'screen_reader_text' => __( 'Page navigation', 'bp' )
				));
	...
	<?php edit_post_link( __( 'Edit', 'bp' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
